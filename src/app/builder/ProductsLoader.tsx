...
function getFallbackProducts(category: string): Component[] {
  const fallbacks: Record<string, Component[]> = {
    ...
    storage: [
      { id: '1', name: 'WD Blue SN580 1TB', brand: 'WD', price: 66, finalPrice: 66, specs: 'NVMe Gen4, 4150MB/s', link: bigBangSearch('WD Blue SN580 1TB'), url: bigBangSearch('WD Blue SN580 1TB'), image: '', category: 'SSD', inStock: true, stock: 20, discount: 0, description: '', reason: 'Solidan NVMe SSD' },
      { id: '2', name: 'Samsung 980 PRO 1TB', brand: 'Samsung', price: 106, finalPrice: 106, specs: 'NVMe Gen4, 7000MB/s', link: bigBangSearch('Samsung 980 PRO 1TB'), url: bigBangSearch('Samsung 980 PRO 1TB'), image: '', category: 'SSD', inStock: true, stock: 15, discount: 0, description: '', reason: 'Premium SSD' },
    ],
    psu: [
      { id: '1', name: 'Corsair CX650', brand: 'Corsair', price: 66, finalPrice: 66, specs: '650W, 80+ Bronze', link: bigBangSearch('Corsair CX650'), url: bigBangSearch('Corsair CX650'), image: '', category: 'PSU', inStock: true, stock: 12, discount: 0, description: '', reason: 'Pouzdano napajanje' },
